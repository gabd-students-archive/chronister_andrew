...
# Calculate 3 + 4
3 + 4
# yes, code appears in green and has no effect on the operations of the code

# Calculate 6 + 12
6 + 12 

#The result of running the code is the two numbers listed below
...
#and I had to look up what modulo was. It has been 30 years since my last math class. There is no eye-roll emoji in R, is there?
...
#The value of x, 42, appears below.  
```
...
#I also noticed that once "my_apples" was assigned, it popped up as a shortcut option when I started typing it. Nice. 
```
...
#In the results below, the values for my_apples and my_oranges are displayed, then the sum of both, then the value of my_fruit, which is the same thing.
```
