...
names(total_week) <- "Total Week's Winnings"
...
names(total_poker) <- "Total Poker Winnings"
total_poker
names(total_roulette) <- "Total Roulette Winnings"
total_roulette


#Realize that you suck at roulette and should stay away from the bouncing ball. 
...
names(poker_midweek) <- days_vector[c(2,3,4)]
poker_midweek
...
names(roulette_selection_vector) <- days_vector[2:4]
...
names(poker_start) <- days_vector[1:3]
poker_start
mean(poker_start)
