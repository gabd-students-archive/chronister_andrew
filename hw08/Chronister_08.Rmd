...
lake_ice2
```
#Looks like the duration is in days.  BTW, I was able to filter the -999 values to NA, but cant figure out how to combine the two 1953 values into one.  I'll open an issue when I get the rest of the assignment done.  
...
soil_co2_sum <- soil_co2 %>%
  summarize(
    ...
    StdErrCO2 = sd(Corrected_CO2_Level)/sqrt(NROW(soil_co2))
  )
soil_co2_sum
